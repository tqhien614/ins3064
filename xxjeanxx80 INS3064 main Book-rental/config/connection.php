...
if (!defined('SERVER_PATH')) {
    define('SERVER_PATH', $_SERVER['DOCUMENT_ROOT'] . '/ins3064/xxjeanxx80 INS3064 main Book-rental/');
}

// Đường dẫn truy cập website (site path)
if (!defined('SITE_PATH')) {
    define('SITE_PATH', 'http://localhost/ins3064/xxjeanxx80 INS3064 main Book-rental/');
}
